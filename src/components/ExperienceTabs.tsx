							...
							<div className='grid grid-cols-1 pt-8 md:grid-cols-1 lg:grid-cols-2 box-content gap-2'>
								...
								<div className='flex gap-6 flex-col p-4'>
									<div>
										...
										<ul className='list-disc list-outside lg:pl-8 md:pl-8 pl-4 text-base lg:text-xl md:text-xl'>
											<li>
									...
									<div>
										...
										<ul className='list-disc list-outside lg:pl-8 md:pl-8 pl-4 text-base md:text-xl lg:text-xl '>
											<li>
												Moving Dealer & DRE App from native code to Flutter and
												Develop new features
											</li>
						...
						<Tab.Panel>
							<div className='grid grid-cols-1 pt-8 md:grid-cols-1 lg:grid-cols-2 box-content gap-2'>
								...
								<div className='flex gap-6 flex-col p-4'>
									...
									<p className='text-base lg:text-xl md:text-xl pt-2  whitespace-pre-line lg:pl-4 md:pl-4'>
